This was a practice project using fictional client data consisting of client ID's, locations, multiple survey responses, and various details stored as string data. 
